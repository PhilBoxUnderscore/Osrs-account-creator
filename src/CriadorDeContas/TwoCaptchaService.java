...
import org.dreambot.api.methods.MethodProvider;
	...
	public class TwoCaptchaService {
		...
		public String solveCaptcha() throws InterruptedException, IOException {
			MethodProvider.log("Sending recaptcha challenge to 2captcha.com");
			...
			do {
				...
				timeCounter++;
				MethodProvider.log("Waiting for captcha to be solved... elapsed " + timeCounter);
			} while(hw.getHtml().contains("NOT_READY"));
			MethodProvider.log("It took "  + timeCounter + " seconds to solve the captcha");
